...
.stButton button,.stDownloadButton button{background:#0B3B67!important;color:white!important;border-radius:10px!important;font-weight:800!important}.stButton button:hover,.stDownloadButton button:hover{background:#D4A017!important;color:#071A2F!important}section[data-testid="stSidebar"] label p{color:#F3C84B!important;-webkit-text-fill-color:#F3C84B!important;font-weight:800!important}section[data-testid="stSidebar"] div[data-testid="stSelectbox"] [data-baseweb="select"]>div{background:#FFF!important;border:2px solid #F3C84B!important;border-radius:10px!important}section[data-testid="stSidebar"] div[data-testid="stSelectbox"] *{color:#071A2F!important;-webkit-text-fill-color:#071A2F!important;font-weight:800!important}section[data-testid="stSidebar"] div[data-testid="stButton"] button{background:linear-gradient(135deg,#F3C84B,#D4A017)!important;color:#071A2F!important;border:2px solid #F9DC79!important;min-height:46px!important;font-weight:850!important}
